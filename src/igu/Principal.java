...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnSortear.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/loteria64x64.png"))); // NOI18N
    ...
    public String agregarCeros(int randomDia, int randomTicket, String mes) {
    ...
    public String sortear() {
        ...
        String numeroSorteado = agregarCeros(randomDia, randomTicket, mes);

        return numeroSorteado;
    }

    public void agregarValorATabla(int countSorteo, String numeroSorteado) {
